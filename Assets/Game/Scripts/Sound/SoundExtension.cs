...
public static class SoundExtension
{
    ...
    public static int? PlayMusic(this SoundComponent soundComponent, string assetName, object userData = null)
    {
        ...
        playSoundParams.Loop = true;
        playSoundParams.VolumeInSoundGroup = 1f;
        playSoundParams.FadeInSeconds = Constant.Audio.FadeVolumeDuration;
        playSoundParams.SpatialBlend = 0f;
    ...
    public static int? PlaySound(this SoundComponent soundComponent, SoundInfo info, Entity bindingEntity = null, object userData = null)
    {
        PlaySoundParams playSoundParams = PlaySoundParams.Create();
        playSoundParams.Priority = info.priority;
        playSoundParams.Loop = info.loop;
        playSoundParams.VolumeInSoundGroup = info.volumeInSoundGroup;
        playSoundParams.SpatialBlend = info.spatialBlend;

        return soundComponent.PlaySound(AssetUtility.GetSoundAsset(info.assetName), "Sound", Constant.AssetPriority.SoundAsset, playSoundParams, bindingEntity, userData);
    }
    ...
    public static int? PlayUISound(this SoundComponent soundComponent, SoundInfo info, object userData = null)
    {
        PlaySoundParams playSoundParams = PlaySoundParams.Create();
        playSoundParams.Priority = info.priority;
        playSoundParams.Loop = info.loop;
        ...
        return soundComponent.PlaySound(AssetUtility.GetUISoundAsset(info.assetName), "Sound", Constant.AssetPriority.UISoundAsset, playSoundParams, userData);
    }

    public static int? PlayUISound(this SoundComponent soundComponent, string assetName, object userData = null)
    {
        PlaySoundParams playSoundParams = PlaySoundParams.Create();
        playSoundParams.Priority = 64;
        playSoundParams.Loop = false;
        ...
        return soundComponent.PlaySound(AssetUtility.GetUISoundAsset(assetName), "Sound", Constant.AssetPriority.UISoundAsset, playSoundParams, userData);
    }
    #endregion
